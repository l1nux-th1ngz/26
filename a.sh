#!/bin/bash
#
# This file contains commands that will be executed at the end of
...
_PostInstallCommands() {
    ...
    # ...
     echo "# Fucking Genius!" >> /home/$username/.bashrc
     pacman -S --noconfirm --needed geany chromium libreoffice-fresh xtra-cmake-modules boost python-jsonschema python-unidecode gawk qt5-svg qt5-webengine yaml-cpp networkmanager upower  
     squashfs-tools rsync cryptsetup qt5-xmlpatterns doxygen dmidecode gptfdisk hwinfo polkit-qt5  
     solid5 qt5-tools boost-libs libpwquality ckbcomp qt5-quickcontrols2
